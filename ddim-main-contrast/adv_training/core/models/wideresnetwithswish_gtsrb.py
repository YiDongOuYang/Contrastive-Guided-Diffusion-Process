...
CIFAR10_MEAN = (0.3403, 0.3121, 0.3214)
CIFAR10_STD = (0.2724, 0.2608, 0.2669)
...
class WideResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        return out#out#self.logits(out)
    
    
def wideresnetwithswish(name, dataset='gtsrb', num_classes=43, device='cpu'):
    """
