...
def load_gtsrbs(data_dir, use_augmentation=False, aux_take_amount=None, 
    ...
    """
    data_dir = re.sub('gtsrbs', 'gtsrb', data_dir)
    ...
    train_dataset = SemiSupervisedGTSRB10( base_dataset='gtsrb', root=data_dir, train=True, download=True, 
    ...
    test_dataset = SemiSupervisedGTSRB10( base_dataset='gtsrb', root=data_dir, train=False, download=True, 
                                         transform=test_transform)
    if validation:
        val_dataset = SemiSupervisedGTSRB10(base_dataset='gtsrb', root=data_dir, train=True, download=True, transform=test_transform)
...
class SemiSupervisedGTSRB10(SemiSupervisedDataset):
    ...
    def load_base_dataset(self, train=False, **kwargs):
        ...
        self.dataset = GTSRB( train=train, **kwargs)
